...
export default function Hero() {
  return (
    <section id="top" className="relative overflow-hidden bg-ink">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 pb-16 pt-14 sm:px-8 sm:pt-20 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8 lg:pb-24">
        {/* Copy column */}
        <div className="flex flex-col justify-center text-white">
          ...
          <p className="mt-6 max-w-md font-body text-lg leading-relaxed text-white/75">
            Independent MOT testing, servicing and repairs from technicians
